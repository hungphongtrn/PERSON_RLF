...
#             if (
#                 not isinstance(kwargs["sentence"].strip(), str)
#                 or len(kwargs["sentence"].strip()) == 0
#             ):
...
#         """
#         self.stopwords = (
#             stopwords.words("english") if stop_words is None else stop_words
#         )
#         self.sentence = None
#         self.p = None
#         self.n = None
...
#         random_word_list = sorted(
#             list(set([word for word in words if word not in self.stopwords]))
#         )
