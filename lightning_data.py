    ...
    def setup(self, stage=None):
        if stage == "fit" or stage is None:
            train_transforms = build_transforms(
                img_size=self.args.img_size, aug=self.args.img_aug, is_train=True
            )
            val_transforms = build_transforms(
                img_size=self.args.img_size, is_train=False
            )
            ...
            self.val_img_set = ImageDataset(
                ds["image_pids"], ds["img_paths"], val_transforms
            )
        ...
        if stage == "test" or stage is None:
            ...
            self.test_img_set = ImageDataset(
                ds["image_pids"], ds["img_paths"], test_transforms
            )
